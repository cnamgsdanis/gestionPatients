...
CREATE TABLE Patient (
    ...
    -- NAG = INT, exactement 10 chiffres (chiffres uniquement). Pas de prefixe impose.
...
-- Unicite du NAG (plusieurs NULL autorises via index filtre)
CREATE UNIQUE INDEX UQ_Patient_matricule_nag
    ON Patient(matricule_nag)
    WHERE matricule_nag IS NOT NULL;
GO

-- Unicite du telephone (plusieurs NULL autorises)
