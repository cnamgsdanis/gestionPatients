...
BEGIN
    CREATE TABLE Patient (
        ...
        -- NAG = INT, exactement 10 chiffres (chiffres uniquement, entre 1000000000 et 2147483647)
        matricule_nag       INT           NULL
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UQ_Patient_contact' AND object_id = OBJECT_ID('Patient'))
BEGIN
    CREATE UNIQUE INDEX UQ_Patient_contact
        ON Patient(contact)
...
PRINT 'Creation du schema de base de donnees terminee avec succes.';
GO